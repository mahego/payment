...
export const customerSchema = z.object({
  ...
  mikrotikProfileId: z.string().optional().or(z.literal('')),
  serviceMode: z.enum(['PPPOE', 'SIMPLE_QUEUE', 'HOTSPOT', 'ADDRESS_LIST']).default('PPPOE'),
  pppoeUsername: z.string().optional().or(z.literal('')),
  pppoePassword: z.string().optional().or(z.literal('')),
  ipAddress: z.string().optional().or(z.literal('')),
  simpleQueueName: z.string().optional().or(z.literal('')),
  hotspotUsername: z.string().optional().or(z.literal('')),
  macAddress: z.string().optional().or(z.literal('')),
  suspensionAddressList: z.string().optional().or(z.literal('')),
