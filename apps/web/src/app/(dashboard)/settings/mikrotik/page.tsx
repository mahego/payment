...
export default function MikrotikSettingsPage() {
  ...
  return (
    <div className="space-y-8 max-w-5xl">
      ...
      {showForm && (
        <section className="glass-card glass-shine bg-white/70 border-white/40 p-6 shadow-glass">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex justify-end gap-2 pt-4 border-t border-slate-100">
              <button
                type="button"
                onClick={resetForm}
                className="rounded-xl border border-slate-200/60 bg-white/40 px-4 py-2 text-sm font-semibold text-slate-700 shadow-glass hover:bg-white/60 hover:-translate-y-0.5 transition duration-300"
              >
                Cancelar
              </button>
              <button
      ...
      {/* Profile List */}
      <section className="overflow-hidden glass-card glass-shine bg-white/70 border-white/40 shadow-glass p-0">
